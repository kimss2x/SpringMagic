...
Blender 5.0 on Windows. It provides a physically based bone animation system with
spring, force, and wind effects for natural secondary motion.
...
6. Click Calculate Physics to bake keys.
7. Use Clear Animation to remove generated keys.
